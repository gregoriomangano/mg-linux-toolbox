...
Il file ufficiale è `MG-Linux-Toolbox-0.9.0-beta.2-x86_64.AppImage` ed è disponibile nella [Release v0.9.0-beta.2](https://github.com/gregoriomangano/mg-linux-toolbox/releases/tag/v0.9.0-beta.2).
