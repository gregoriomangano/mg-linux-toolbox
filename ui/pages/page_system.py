...
from ui.widgets import SwitchRow, report_toggle_result
...
class SystemPage(Adw.PreferencesPage):
    def __init__(self):
        ...
        # Cache cleanup moved to Software e repository -> Salute
        # pacchetti (2026-08-04) — this page keeps only what's directly
        # tied to the physical disk (TRIM, SMART).
